...
**Code Authors and Contributors:** Sarah Supp, Cam Phan, Jessy Niu, Kairuo Yan, Eun Young Lee, Maximilian Wisnefski (Denison University), Frank A. La Sorte (Cornell University)
...
| ERC_shapefile_2023/junivirg.*  | shapefiles for eastern redcedar range polygon, W. Haas | processed data  |


### Code files

This project requires multiple code files that achieve different steps in the data processing, analysis, and visualizations. RMarkdown code files are stored in the folder `code`.
...
| make-figures-and-maps.Rmd | This file contains code to generate figures and maps depicting the data and the results | outputs figures and maps |
