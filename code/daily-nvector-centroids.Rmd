...
files = list.files(path=here("data/2-intermediate_eBird_data/species_effort/"),
                   pattern=glob2rx("dat_effort*.rds"))
...
# write a copy of the species-merged data, before the next steps
saveRDS(spdata, file=here("data/2-intermediate_eBird_data/dat_effort_merged.rds"))
```
